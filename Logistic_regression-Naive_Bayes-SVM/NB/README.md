# Machine learning supervisé - Naive Bayes
...
* [Naive Bayes](#naive-bayes)
  * [Cas où <img src="https://latex.codecogs.com/svg.latex?\Large&space;X_i" /> est qualitative](#cas-où--est-qualitative)
  * [Cas où <img src="https://latex.codecogs.com/svg.latex?\Large&space;X_i" /> est quantitative](#cas-où--est-quantitative)
...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;P(A/B)=\frac{P(B/A)\cdot{P(A)}}{P(B)}" />
...
### Cas où <img src="https://latex.codecogs.com/svg.latex?\Large&space;X_i" /> est qualitative
...
### Cas où <img src="https://latex.codecogs.com/svg.latex?\Large&space;X_i" /> est quantitative
