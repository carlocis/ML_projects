# Réduction de dimensions - ACP AFD
...
* [Réduction de dimensions](#réduction-de-dimensions)
  * [Analyse en composantes principales (ACP)](#analyse-en-composantes-principales-acp)
    * [Intuition](#intuition)
    * [Remarque importante](#remarque-importante)
    * [Décomposition de la matrice des covariances](#décomposition-de-la-matrice-des-covariances)
    * [Analyse en composantes principales](#analyse-en-composantes-principales)
  * [Analyse factorielle discriminante](#analyse-factorielle-discriminante)
    * [Intuition](#intuition-1)
    * [Analyse factorielle discriminante](#analyse-factorielle-discriminante-1)
<!-- TOC END -->
...
#### Décomposition de la matrice des covariances
...
#### Analyse factorielle discriminante
##### Matrice des variances-covariances totale
...
##### Matrice des variances-covariances inter-groupes
