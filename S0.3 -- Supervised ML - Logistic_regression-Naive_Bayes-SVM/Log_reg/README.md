# Machine learning supervisé - Régression logistique
...
* [Régression logistique](#régression-logistique)
  * [Comment faire notre classification](#comment-faire-notre-classification)
  * [Régression logistique en python](#régression-logistique-en-python)
  * [Faux positifs - Faux Négatifs](#faux-positifs---faux-négatifs)
    * [Faux positif](#faux-positif)
    * [Faux négatif](#faux-négatif)
    * [Soyez attentifs aux faux positif et SURTOUT faux négatifs](#soyez-attentifs-aux-faux-positif-et-surtout-faux-négatifs)
    * [Comment évaluer votre modèle](#comment-évaluer-votre-modèle)
    * [Matrice de confusion](#matrice-de-confusion)
    * [Matrice de confusion en python](#matrice-de-confusion-en-python)
    * [Courbe ROC, AUC et indice de GINI](#courbe-roc-auc-et-indice-de-gini)
    * [Courbe ROC, AUC en python](#courbe-roc-auc-en-python)
* [Comment se protéger du sur-apprentissage ?](#comment-se-protéger-du-sur-apprentissage-)
  * [Cross Validation en python](#cross-validation-en-python)
<!-- TOC END -->
...
### Comment faire notre classification  
...
#### Soyez attentifs aux faux positif et SURTOUT faux négatifs
...
#### Courbe ROC, AUC et indice de GINI
...
## Comment se protéger du sur-apprentissage ?
